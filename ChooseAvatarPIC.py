...
if __name__ == "__main__":
	...
	avtr1 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a1.png').resize((size, size)), Image.LANCZOS)
	avtr2 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a2.png').resize((size, size)), Image.LANCZOS)
	avtr3 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a3.png').resize((size, size)), Image.LANCZOS)
	avtr4 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a4.png').resize((size, size)), Image.LANCZOS)
	avtr5 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a5.png').resize((size, size)), Image.LANCZOS)
	avtr6 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a6.png').resize((size, size)), Image.LANCZOS)
	avtr7 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a7.png').resize((size, size)), Image.LANCZOS)
	avtr8 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a8.png').resize((size, size)), Image.LANCZOS)
	avtr9 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a9.png').resize((size, size)), Image.LANCZOS)
	avtr10 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a10.png').resize((size, size)), Image.LANCZOS)
	avtr11 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a11.png').resize((size, size)), Image.LANCZOS)
	avtr12 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a12.png').resize((size, size)), Image.LANCZOS)
	avtr13 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a13.png').resize((size, size)), Image.LANCZOS)
	avtr14 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a14.png').resize((size, size)), Image.LANCZOS)
	avtr15 = ImageTk.PhotoImage(Image.open('extrafiles/images/avatars/a15.png').resize((size, size)), Image.LANCZOS)
